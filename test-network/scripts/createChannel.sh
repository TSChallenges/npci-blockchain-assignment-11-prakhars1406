...
infoln "Joining TataMotors peer to the channel..."
joinChannel 1
infoln "Joining ICICIBank peer to the channel..."
joinChannel 2
infoln "Joining Tesla peer to the channel..."
joinChannel 4
infoln "Joining ChaseBank peer to the channel..."
joinChannel 5

## Set the anchor peers for each org in the channel
infoln "Setting anchor peer for TataMotors..."
setAnchorPeer 1
infoln "Setting anchor peer for ICICIBank..."
setAnchorPeer 2
infoln "Setting anchor peer for Tesla..."
setAnchorPeer 4
infoln "Setting anchor peer for ChaseBank..."
setAnchorPeer 5
